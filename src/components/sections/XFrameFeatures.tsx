      ...
      {features.map((feature, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-md rounded-2xl p-8 lg:p-9 border border-white/15 group-hover:border-[#C4704B]/40 transition-all duration-300 overflow-hidden h-full">
                {/* Subtle inner glow */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#C4704B]/0 group-hover:bg-[#C4704B]/10 rounded-full blur-3xl transition-all duration-500" />

                {/* Header row */}
                <div className="flex items-center justify-between mb-6 relative">
                  {/* Icon box with glow */}
                  <div className="relative">
                    <div className="absolute -inset-2 bg-[#C4704B]/0 group-hover:bg-[#C4704B]/30 rounded-2xl blur-xl transition-all duration-500" />
                    <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-[#C4704B]/30 to-[#C4704B]/10 group-hover:from-[#C4704B] group-hover:to-[#C4704B]/80 flex items-center justify-center transition-all duration-300 border border-[#C4704B]/20 group-hover:border-[#C4704B]/50">
                      <Icon className="w-7 h-7 text-[#C4704B] group-hover:text-white transition-colors duration-300 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" />
                    </div>
                  </div>
                  ...
                  >
                    <div className="absolute -inset-2 bg-[#C4704B]/0 group-hover:bg-[#C4704B]/20 rounded-full blur-lg transition-all duration-500" />
                    <div className="relative px-4 py-2 bg-gradient-to-br from-[#C4704B]/20 to-[#C4704B]/10 rounded-xl border border-[#C4704B]/30 group-hover:border-[#C4704B]/50 transition-all duration-300">
        ...
        return (
          <motion.div
            ...
            className="bg-[#FAF7F2] rounded-2xl p-8 hover:shadow-lg transition-all duration-300 group border border-[#DDD5C9] hover:border-[#C4704B]/30"
          >
            <div className="flex items-center justify-between mb-6">
              <div className="w-14 h-14 bg-[#C4704B]/10 rounded-xl flex items-center justify-center group-hover:bg-[#C4704B] transition-colors">
                <Icon className="w-7 h-7 text-[#C4704B] group-hover:text-white transition-colors" />
              </div>
              <span className="text-2xl font-bold text-[#C4704B]">{feature.stat}</span>
            </div>
