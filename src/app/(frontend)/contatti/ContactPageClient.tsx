...
export default function ContactPageClient({ onSubmit }: ContactPageClientProps) {
  return (
    <main className="min-h-screen bg-[#FAF7F2]">
      {/* HERO COMPATTO */}
      <section className="relative bg-[#1E3D30] py-28 lg:py-36">
        {/* Subtle decorative dots */}
        <div className="absolute top-16 left-16 w-2 h-2 rounded-full bg-[#C4704B]/25" />
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          >
            <a
              href="#form"
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#C4704B] hover:bg-[#B35F3A] text-white font-semibold rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-[#C4704B]/20"
            >
        ...
        <div className="max-w-6xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#1E3D30] mt-3 mb-4">
                Come contattarci
              </h2>
              ...
              <p className="text-[#6B6560] text-lg max-w-2xl mx-auto mt-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                >
                  <SpotlightCard className="bg-white p-7 border border-[#DDD5C9] h-full hover-lift gradient-sweep text-center">
                    <div className="w-14 h-14 mx-auto mb-5 bg-[#1E3D30]/5 group-hover:bg-[#1E3D30]/10 rounded-2xl flex items-center justify-center transition-colors duration-300">
                    ...
                    <p className="text-[#6B6560]/60 text-xs">{method.sub}</p>
                  </SpotlightCard>
                </a>
              </ScrollReveal>
            ))}
      ...
      {/* FORM SECTION */}
      <section id="form" className="py-28 lg:py-36 bg-[#FAF7F2]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <ScrollReveal direction="left">
              <div className="lg:sticky lg:top-32">
                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                  <SpotlightCard className="p-5 bg-white border border-[#DDD5C9] hover-lift">
                    ...
                    <p className="text-[#6B6560] text-sm">Lun - Ven: 9:00 - 18:00</p>
                    <p className="text-[#6B6560] text-sm">Sabato: 9:00 - 13:00</p>
                  </SpotlightCard>
                  ...
                  <SpotlightCard className="p-5 bg-white border border-[#DDD5C9] hover-lift">
                    ...
                    <p className="text-[#6B6560] text-sm">Via Conte Ruggiero, 128</p>
                    <p className="text-[#6B6560] text-sm">89822 Spadola (VV)</p>
                  </SpotlightCard>
                </div>

                <div className="p-7 bg-[#1E3D30] rounded-2xl shadow-premium-lg">
            ...
            <ScrollReveal direction="right" delay={0.15}>
              <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-premium-xl border border-[#DDD5C9]/50">
                <div className="mb-8">
                  <h3 className="font-serif text-2xl text-[#1E3D30] mb-2">Richiedi Informazioni</h3>
                  <p className="text-[#6B6560] text-sm">Ti risponderemo entro 24 ore</p>
                  <div className="mt-4 flex items-center gap-3">
                    <div className="w-8 h-0.5 bg-[#C4704B]" />
      ...
      <section className="relative bg-white">
        <div className="relative h-[500px]">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 sm:left-8 sm:translate-x-0 w-[90%] sm:w-auto max-w-md z-20">
            <div className="bg-white rounded-2xl p-6 shadow-premium-xl border border-[#DDD5C9]/50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#6B6560] text-sm mt-1">Via Conte Ruggiero, 128</p>
                  <p className="text-[#6B6560] text-sm">89822 Spadola (VV), Calabria</p>
                  <div className="flex gap-3 mt-4">
                    <a
                      href="https://maps.google.com/?q=Via+Conte+Ruggiero+128+Spadola+VV"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#1E3D30] hover:bg-[#2D5A47] text-white text-sm font-medium rounded-lg transition-colors duration-300"
                    >
                    ...
                    <a
                      href="tel:+3909631951395"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#C4704B] hover:bg-[#B35F3A] text-white text-sm font-medium rounded-lg transition-colors duration-300"
                    >
