...
import {
  Briefcase, CheckCircle, Clock, Zap, Shield, Wifi,
  ChevronDown, Phone, ArrowLeft, Layers, Building2,
  LayoutGrid, Cable, Volume2, Thermometer, Puzzle, Award,
  type LucideIcon
} from 'lucide-react'
...
import { BentoGrid, BentoItem, BentoFeatureCard } from '@/components/ui/BentoGrid'
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(90deg, #1E3D30, #C4704B, #40916c, #1E3D30)',
...
const featureIcons: Record<string, LucideIcon> = {
  'Layout flessibile': LayoutGrid,
  'Cablaggio integrato': Cable,
  'Acustica ottimizzata': Volume2,
  'Climatizzazione efficiente': Thermometer,
  'Espandibile modulare': Puzzle,
  'Immagine professionale': Award
}
...
export default function SmartSuitePage() {
  ...
  const additionalBenefits = [
    {
      icon: Layers,
      title: 'Modularita Totale',
      description: 'Spazi che crescono con il tuo business. Aggiungi moduli in qualsiasi momento senza interruzioni.'
    },
    {
      icon: Wifi,
      title: 'Infrastruttura Tech',
      description: 'Predisposizione per fibra ottica, rete dati strutturata e sistemi di videoconferenza.'
    },
    {
      icon: Shield,
      title: 'Immagine Professionale',
      description: 'Design contemporaneo che comunica innovazione e attenzione all\'ambiente ai tuoi clienti.'
    },
    {
      icon: Zap,
      title: 'Costi Operativi Ridotti',
      description: 'Massima efficienza energetica per un ambiente di lavoro ottimale e costi contenuti.'
    },
  ]

  // Parse stats from tipologia
  const stats = useMemo(() => [
    { value: 30, suffix: '', label: 'Giorni minimi', icon: Clock },
    { value: 40, suffix: ' m²', label: 'Superficie max', icon: Building2 },
    { value: 30, suffix: ' anni', label: 'Garanzia', icon: Shield },
    { value: 100, suffix: '%', label: 'Personalizzabile', icon: Puzzle }
  ], [])
  ...
  return (
    <main className="min-h-screen bg-[#FFFCF7] overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-[#1E3D30] mb-6">
              Il tuo business merita uno{' '}
              <span className="relative">
                <span style={{ color: tipologia.color }}>spazio smart</span>
                <motion.span
      ...
      <section className="py-20 lg:py-28 px-4 bg-white relative overflow-hidden">
        <AnimatedGridBackground color="#1E3D30" />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <motion.span
              ...
              viewport={{ once: false }}
              className="inline-block px-4 py-2 bg-[#1E3D30]/10 rounded-full text-[#1E3D30] text-sm font-medium mb-4"
            >
              Caratteristiche
            </motion.span>
            ...
            <p className="text-[#6B6560] text-lg">Ogni dettaglio progettato per la produttivita</p>
          </motion.div>
            ...
            {tipologia.features.map((feature, i) => {
              ...
              return (
                <BentoFeatureCard
                  ...
                  title={feature}
                  description={i === 0 ? 'Configura gli spazi secondo le tue esigenze. Pareti divisorie mobili, aree open space, sale riunioni dedicate.' : undefined}
                  size={size}
                  color={tipologia.color}
                  delay={i * 0.1}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              I vantaggi di <span style={{ color: tipologia.color }}>SmartSuite</span>
            </h2>
            <p className="text-white/60 text-lg">Perche scegliere noi per il tuo spazio di lavoro</p>
          </motion.div>
          ...
          <div className="text-center relative">
            ...
            >
              ...
              <motion.span
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: false }}
                className="inline-block px-4 py-2 bg-[#1E3D30]/10 rounded-full text-[#1E3D30] text-sm font-medium mb-6"
              >
                Inizia Oggi
              </motion.span>
              ...
              <p className="text-[#6B6560] text-lg md:text-xl mb-10 max-w-xl mx-auto leading-relaxed">
                Contattaci per un sopralluogo gratuito e scopri come SmartSuite puo trasformare il tuo modo di lavorare.
              </p>
