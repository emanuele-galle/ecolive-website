...
const slideInRightVisible = { opacity: 1, x: 0 }
const slideOutLeft = { opacity: 0, x: -50 }
const transitionDuration04 = { duration: 0.4 }
...
export default function ConfiguratoreClient({ onSubmit }: ConfiguratoreClientProps) {
  ...
  const { step, goBack } = useConfiguratorV2()
        ...
        <AnimatePresence mode="wait">
          {step === 'select-house' && (
            <motion.div
              ...
              exit={fadeOut}
              transition={transitionDuration04}
