...
const sections = [
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-600">
        ...
        delle richieste di preventivo; <strong className="text-[#1D1D1F]">legittimo interesse</strong> del Titolare per finalità
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-600">
        I dati personali sono conservati per il tempo strettamente necessario a conseguire le finalità per cui
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 mb-4">
          In conformità al GDPR (Regolamento UE 2016/679), l&apos;interessato può esercitare i seguenti diritti:
        </p>
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-600">
        Questo sito utilizza cookie tecnici necessari al funzionamento e cookie di terze parti per finalità
    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <section className="py-12 lg:py-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Contact CTA */}
          <div className="mt-12 p-8 bg-[#1D1D1F] rounded-2xl text-center">
