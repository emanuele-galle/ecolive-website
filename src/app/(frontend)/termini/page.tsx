...
const sections = [
      ...
      <>
        ...
        <div className="space-y-3">
          {[
            ...
            { do: true, text: 'Rispettare la proprietà intellettuale dei contenuti' },
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 mb-4">
          Ecolive S.r.l. non è responsabile per:
        </p>
        <ul className="space-y-2 text-gray-600">
          <li className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
            <span>Danni derivanti dall&apos;impossibilità di accedere al sito</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-600">
        Questo sito può contenere link a siti web di terze parti. Ecolive S.r.l. non ha alcun controllo
        su tali siti e non è responsabile dei loro contenuti, politiche sulla privacy o pratiche.
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-600">
        ...
        relativa all&apos;interpretazione o esecuzione dei presenti termini sarà competente in via esclusiva
        il Foro di Vibo Valentia, salvo il caso in cui l&apos;utente sia qualificabile come consumatore ai
        sensi del D.Lgs. 206/2005, nel qual caso sarà competente il foro del luogo di residenza o
