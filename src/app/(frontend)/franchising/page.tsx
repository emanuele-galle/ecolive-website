...
export default function FranchisingPage() {
  return (
    <main className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative py-24 bg-gradient-to-br from-[#1E3D30] to-[#2D5A47]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <span className="inline-block px-4 py-2 mb-6 text-sm font-medium text-[#C4704B] bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            Opportunità di Business
          </span>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Diventa Partner
            <span className="block text-[#C4704B]">Ecolive</span>
          </h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1E3D30] mb-12 text-center">Cosa Offriamo</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => {
              const Icon = benefit.icon
              return (
                <div key={index} className="text-center">
                  <div className="w-16 h-16 bg-[#C4704B]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Icon className="w-8 h-8 text-[#C4704B]" />
                  </div>
                  <h3 className="text-xl font-bold text-[#1E3D30] mb-2">{benefit.title}</h3>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1E3D30] mb-12 text-center">Tipi di Partnership</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {partnershipTypes.map((type, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-sm">
                <h3 className="text-2xl font-bold text-[#1E3D30] mb-4">{type.title}</h3>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1E3D30] mb-8 text-center">Requisiti</h2>
      ...
      {/* CTA */}
      <section className="py-20 px-4 bg-[#C4704B]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/contatti" className="inline-flex px-8 py-4 bg-white text-[#C4704B] font-semibold text-lg rounded-xl hover:bg-gray-100 transition-colors">
