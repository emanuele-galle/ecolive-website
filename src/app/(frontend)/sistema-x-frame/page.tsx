...
import MaterialsComparison from '@/components/sections/MaterialsComparison'
...
const premiumMaterials = [
  {
    ...
    othersUse: 'Massello',
    costMultiplier: '2x',
    description: 'Il BILAM e legno lamellare analizzato, tagliato nei punti deboli e incollato. Garantisce stabilita dimensionale assoluta: non si muove, non si deforma, nessun nodo critico che comprometta la struttura.',
    icon: (
  ...
  },
  {
    ...
    othersUse: 'OSB',
    costMultiplier: '3x',
    description: "L'OSB e fatto di scarti di lavorazione, instabile e soggetto a umidita. I nostri pannelli a 3 strati coprono l'intera parete in un unico pezzo, con resistenza strutturale incomparabile.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Sughero Alta Densita',
    othersUse: 'Polistirene',
    costMultiplier: '4-5x',
    description: 'Spessore dimezzato, stesse performance. 100% naturale e rinnovabile: la corteccia ricresce senza abbattere nulla. Lo stato dell\'arte dell\'isolamento, non derivati del petrolio.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Gesso-Fibra 25mm',
    othersUse: 'Cartongesso 12mm',
    costMultiplier: '3x',
    description: 'Doppio spessore, resistenza agli urti (non si sfonda con un pugno), capacita di accumulo termico superiore. Le pareti trattengono caldo e freddo, riducendo i consumi.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Qualita Sartoriale Section Component
function QualitaSartorialeSection() {
  const containerRef = useRef<HTMLDivElement>(null)
  const isInView = useInView(containerRef, { once: false, margin: "-100px" })

  return (
    <section ref={containerRef} className="relative py-24 lg:py-32 px-4 bg-gradient-to-b from-[#1E3D30] via-[#152822] to-[#0a1628] overflow-hidden">
      {/* Grid Pattern Background */}
      <div className="absolute inset-0 opacity-20">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="sartoriale-grid-small" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M 20 0 L 0 0 0 20" fill="none" stroke="#1a3a5c" strokeWidth="0.5"/>
            </pattern>
            <pattern id="sartoriale-grid-large" width="100" height="100" patternUnits="userSpaceOnUse">
              <rect width="100" height="100" fill="url(#sartoriale-grid-small)"/>
              <path d="M 100 0 L 0 0 0 100" fill="none" stroke="#1a3a5c" strokeWidth="1"/>
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#sartoriale-grid-large)"/>
        </svg>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4896A] via-[#E8956B] to-[#D4896A]">
              Sartorialita Italiana
            </span>
          </h2>

          <p className="text-[#7da0b2] text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed mb-6">
            La differenza tra una scarpa artigianale e la produzione di massa
          </p>

          <p className="text-white/60 text-base lg:text-lg max-w-4xl mx-auto leading-relaxed">
            I colossi dell'edilizia prefabbricata producono in serie con macchine automatiche.
            Noi realizziamo ogni struttura come un sarto realizza un abito su misura:
            <span className="text-[#C4704B] font-medium"> materiali premium</span>,
            <span className="text-[#C4704B] font-medium"> connessioni curate singolarmente</span>,
            <span className="text-[#C4704B] font-medium"> finiture di livello superiore</span>.
            Il risultato? Una casa che costa di piu, ma vale ogni centesimo.
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">
            Perche i Nostri Materiali Costano di Piu
          </h3>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 mb-16">
          {premiumMaterials.map((material, index) => (
            ...
            >
              ...
              <div className="absolute -inset-2 bg-gradient-to-br from-[#C4704B]/0 to-transparent rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 group-hover:from-[#C4704B]/20 transition-all duration-500 -z-10" />

              <div className="relative bg-white/[0.04] backdrop-blur-sm rounded-2xl p-8 border border-white/10 group-hover:border-[#C4704B]/30 transition-all duration-300 h-full">
                {/* Header with icon and cost */}
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#C4704B] to-[#a85a3a] flex items-center justify-center text-white shadow-lg shadow-[#C4704B]/30">
                      {material.icon}
                    </div>
                    <div>
                      <h4 className="text-xl font-bold text-white">{material.title}</h4>
                      <p className="text-white/40 text-sm">Altri usano: {material.othersUse}</p>
                    </div>
                  </div>
                  <div className="px-4 py-2 bg-[#C4704B]/20 rounded-full border border-[#C4704B]/30">
                    <span className="text-[#E8956B] font-bold text-lg">{material.costMultiplier}</span>
                    <span className="text-white/50 text-xs ml-1">il prezzo</span>
                  </div>
                </div>
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h4 className="text-2xl font-bold text-white mb-3">Connessioni di Precisione</h4>
              <p className="text-white/60 leading-relaxed mb-4">
                Le nostre connessioni sono realizzate con <span className="text-[#C4704B] font-medium">viti in acciaio al carbonio</span>,
                avvitate singolarmente a bassa velocita. Le macchine automatiche dei grandi produttori "sparano" chiodi in un secondo,
                ma sul legno si lavora a bassa velocita per garantire tenuta perfetta nel tempo,
                resistenza alle sollecitazioni sismiche e al rifollamento naturale del legno.
              </p>
              <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full">
                  <Check className="w-4 h-4 text-green-400" />
                  <span className="text-white/70 text-sm">Durabilita nel tempo</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full">
                  <Check className="w-4 h-4 text-green-400" />
        ...
        >
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-white/70 leading-relaxed">
                Solo per la struttura portante in cemento armato servono
...
export default function SistemaXFramePage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* What is X-Frame - Immersive Dark Section */}
      <section ref={whatIsRef} className="relative overflow-hidden bg-gradient-to-b from-[#1E3D30] via-[#1a3329] to-[#152822]">
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#2D5A47]/30 rounded-full blur-[180px]"
          animate={{
            scale: [1, 1.1, 1],
          }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        ...
        <div className="relative z-10 py-24 lg:py-32">
          {/* Header */}
          <div className="max-w-6xl mx-auto px-4 text-center mb-16 lg:mb-24">
            <motion.div
              initial={{ opacity: 0, y: -20 }}
            ...
            >
              ...
              <span className="text-white/80 text-sm font-medium tracking-wide">La Tecnologia Brevettata</span>
            </motion.div>
            ...
            >
              ...
              <span className="relative">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C4704B] via-[#e08860] to-[#C4704B]">X-Frame</span>
                <motion.span
            ...
            >
              Un sistema costruttivo ibrido brevettato che fonde il meglio di tre tecnologie,
              eliminandone i limiti e potenziandone i vantaggi.
            </motion.p>

            {/* Sartorial approach badge */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={whatIsInView ? { opacity: 1, y: 0 } : {}}
              transition={{ delay: 0.3 }}
              className="mt-6 inline-flex items-center gap-3 px-6 py-3 bg-[#C4704B]/10 rounded-full border border-[#C4704B]/20"
            >
              <svg className="w-5 h-5 text-[#C4704B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
              </svg>
              <span className="text-white/70 text-sm">
                <span className="text-[#C4704B] font-medium">Approccio sartoriale:</span> materiali premium, lavorazione artigianale, zero compromessi
              </span>
            </motion.div>
          </div>

          {/* 3-to-1 Convergence Visual */}
          <div className="max-w-6xl mx-auto px-4 space-y-8">

            {/* Row 1: Platform Frame + X-Lam (2 columns) */}
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              ...
              <motion.div
                ...
                className="group relative"
              >
                <div className="relative overflow-hidden rounded-3xl bg-white/[0.03] backdrop-blur-sm border border-white/10 p-8 h-full transition-all duration-500 hover:bg-white/[0.06] hover:border-[#C4704B]/30 hover:shadow-2xl hover:shadow-[#C4704B]/10">
                  {/* Glow on hover */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#C4704B]/20 rounded-full blur-3xl" />
                  </div>

                  {/* Icon */}
                  <div className="relative mb-6">
                    <motion.div
                      className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#C4704B] to-[#a85a3a] flex items-center justify-center shadow-lg shadow-[#C4704B]/30"
                    ...
                    {/* Number badge */}
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-white/10 rounded-full flex items-center justify-center text-white/60 text-sm font-bold">
                      1
                    </div>
                  </div>

                  <h3 className="text-2xl font-bold text-white mb-3">Platform Frame</h3>
                  <p className="text-white/50 text-sm mb-6">Sistema a telaio leggero</p>

                  {/* Benefits */}
                  <div className="space-y-3">
                    {['Velocita di montaggio', 'Leggerezza strutturale', 'Costi ottimizzati'].map((benefit, i) => (
                      <motion.div
                        key={benefit}
                      ...
                      >
                        <div className="w-1.5 h-1.5 rounded-full bg-[#C4704B]" />
                        <span className="text-white/70 text-sm">{benefit}</span>
                      </motion.div>
                    ))}
                  </div>

                  {/* Arrow pointing down (desktop only) */}
                  <motion.div
                    className="hidden lg:flex absolute -bottom-4 left-1/2 -translate-x-1/2 justify-center"
                    animate={{ y: [0, 5, 0] }}
                    transition={{ duration: 2, repeat: Infinity }}
                  >
                    <svg className="w-8 h-8 text-[#C4704B]/50 rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-white/[0.03] backdrop-blur-sm border border-white/10 p-8 h-full transition-all duration-500 hover:bg-white/[0.06] hover:border-[#C4704B]/30 hover:shadow-2xl hover:shadow-[#C4704B]/10">
                  {/* Glow on hover */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute top-0 left-0 w-32 h-32 bg-[#C4704B]/20 rounded-full blur-3xl" />
                  </div>
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3">X-Lam (CLT)</h3>
                  <p className="text-white/50 text-sm mb-6">Pannelli lamellari incrociati</p>

                  {/* Benefits */}
                  <div className="space-y-3">
                    {['Resistenza sismica', 'Solidita strutturale', 'Durabilita nel tempo'].map((benefit, i) => (
                      <motion.div
                        key={benefit}
                        initial={{ opacity: 0, x: 20 }}
                        animate={whatIsInView ? { opacity: 1, x: 0 } : {}}
            ...
            {/* Row 2: Center X-Frame Card - The Result (Full Width) */}
            <motion.div
              ...
              className="relative"
            >
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#2D5A47] via-[#1E3D30] to-[#152822] border border-[#C4704B]/30 p-10 lg:p-14 shadow-2xl shadow-[#C4704B]/20">
                {/* Premium Pattern */}
                <div
                ...
                {/* Glow Effects */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#C4704B]/30 rounded-full blur-[100px]" />
                ...
                <div className="relative flex flex-col justify-center items-center text-center">
                  ...
                  >
                    <div className="text-7xl md:text-8xl lg:text-[10rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/50">
                      3in1
                    </div>
                    {/* Glow effect behind text */}
                    <div className="absolute inset-0 text-7xl md:text-8xl lg:text-[10rem] font-black text-[#C4704B] blur-3xl opacity-30">
                      3in1
                    </div>
                  </motion.div>

                  <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4">
                    Sistema <span className="text-[#C4704B]">X-Frame</span>
                  </h3>

                  <p className="text-white/60 text-lg lg:text-xl mb-8 max-w-2xl">
                    Tre tecnologie fuse in un unico sistema costruttivo brevettato
                  </p>

                  {/* Patent Badge */}
                  <motion.div
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#C4704B]/20 rounded-full border border-[#C4704B]/30"
                    whileHover={{ scale: 1.05 }}
                  >
                    <svg className="w-5 h-5 text-[#C4704B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <span className="text-white/80 font-medium">Brevetto Ecolive</span>
                  </motion.div>
                </div>
              </div>
            </motion.div>

            {/* Row 3: Post & Beam Card (Centered) */}
            <div className="flex justify-center">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-white/[0.03] backdrop-blur-sm border border-white/10 p-8 h-full transition-all duration-500 hover:bg-white/[0.06] hover:border-[#C4704B]/30 hover:shadow-2xl hover:shadow-[#C4704B]/10">
                  {/* Glow on hover */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#C4704B]/20 rounded-full blur-3xl" />
                  </div>

                  {/* Arrow pointing up (desktop only) */}
                  <motion.div
                    className="hidden lg:flex absolute -top-4 left-1/2 -translate-x-1/2 justify-center"
                    animate={{ y: [0, -5, 0] }}
                    transition={{ duration: 2, repeat: Infinity }}
                  >
                    <svg className="w-8 h-8 text-[#C4704B]/50 -rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold text-white mb-2">Post & Beam</h3>
                      <p className="text-white/50 text-sm mb-4">Travi e pilastri a vista</p>

                      {/* Benefits - Horizontal on desktop */}
                      <div className="flex flex-wrap justify-center md:justify-start gap-3">
                        {['Flessibilita progettuale', 'Grandi aperture', 'Design contemporaneo'].map((benefit, i) => (
                          <motion.div
                            key={benefit}
          ...
          <div className="max-w-6xl mx-auto px-4 mt-16 lg:mt-20">
            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-white/[0.03] backdrop-blur-sm border border-white/10 p-8 lg:p-12">
                {/* Background glow */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-32 bg-[#C4704B]/10 blur-[100px]" />

                <div className="relative grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                  {[
                    { value: 30, suffix: '', label: 'Giorni Montaggio', sublabel: 'per una casa tipo' },
                    { value: 0, suffix: '', label: 'Classe Energetica', sublabel: 'massima efficienza', isText: 'A4' },
                    { value: 25, suffix: '+', label: 'Anni Garanzia', sublabel: 'strutturale' },
                    { value: 100, suffix: '%', label: 'Made in Italy', sublabel: 'produzione locale' },
                  ].map((stat, i) => (
                    <motion.div
                      key={stat.label}
                    ...
                    >
                      <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2">
                        {stat.isText ? (
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C4704B] to-[#e08860]">{stat.isText}</span>
                        ) : (
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C4704B] to-[#e08860]">
      ...
      {/* Qualita Sartoriale Section */}
      <QualitaSartorialeSection />

      {/* Materials Comparison - Perche Costa di Piu */}
      <MaterialsComparison />
